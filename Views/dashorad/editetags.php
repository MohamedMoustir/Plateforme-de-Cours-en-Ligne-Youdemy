...
require_once "../dashorad/editetags.php";
include '../dashorad/afficheTags.php';
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['TagsNom'])) {

        $TagsNom = htmlspecialchars($_POST['TagsNom']);
        $afficherTag = new tags($tagsId, $TagsNom);
        $afficherTag->EditeTags($afficherTag);
    }

}

$afficherTags = new tags();
$afficherTags->afficherTags($afficherTags);
    ...
    <div id="popup" class=" fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 ">
        <div class="bg-white rounded-lg shadow-lg w-96">
            <div class="p-4 border-b">
                <h2 class="text-lg font-semibold text-gray-800">Edite Tags</h2>
            </div>
            <div class="p-4">
                <form class="space-y-4" method="POST">
                    <div>
                        ...
                        <input id="category-name" type="text"
                            ...
                            placeholder="Nom de la catégorie" name="TagsNom" value="<?= $afficherTags->GetTagNom(); ?>">
                    </div>
